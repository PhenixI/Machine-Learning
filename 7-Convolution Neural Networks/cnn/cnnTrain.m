...
% Load MNIST Train
addpath ../../common/;
images = loadMNISTImages('../../data/common/train-images-idx3-ubyte');
images = reshape(images,imageDim,imageDim,[]);
labels = loadMNISTLabels('../../data/common/train-labels-idx1-ubyte');
...
testImages = loadMNISTImages('../../data/common/t10k-images-idx3-ubyte');
testImages = reshape(testImages,imageDim,imageDim,[]);
testLabels = loadMNISTLabels('../../data/common/t10k-labels-idx1-ubyte');
