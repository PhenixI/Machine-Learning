...
for j = 1:hidden_layer_size,
        sumTheta1 = sumTheta1 + sum(Theta10(j,2:end));
end
for j = 1:num_labels,
        sumTheta2 = sumTheta2 + sum(Theta20(j,2:end));
end

J = J + ((sumTheta1 + sumTheta2)*lambda)/(2);
J = J/m;
...
for i = 1:m,
    ...
    z3 = Theta2 * a2;
    a3 = sigmoid(z3);
    % for each output unit k in layer 3 ,set yk
    yi = zeros(num_labels,1);
    yi(y(i)) = 1;
    delta_3 = a3 - yi;
